...
function smarty_cms_help_function_print() {
	...
	<p>This is actually just a wrapper tag for the <a href="listmodules.php?action=showmodulehelp&module=News">Printing module</a> to make the tag syntax easier. 
