...
$perm_table = $config['db_prefix'] . 'permissions';
$perm_seq_table = $config['db_prefix'] . 'permissions_seq';
...
if ($result->RecordCount() > 0) {
    echo '<p>The "Modify Page Structure" permission already exists! Exiting.</p>';
    die();
}

echo '<p>Creating "Modify Page Structure" permission...</p>';

$perm_id = $db->GenID($config['db_prefix'] . 'permissions_seq');
$table  = $config['db_prefix'] . 'permissions';
