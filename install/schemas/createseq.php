...
if (isset($CMS_INSTALL_CREATE_TABLES)) {
	...
	$db->CreateSequence($db_prefix."additional_users_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."admin_bookmarks_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."admin_recent_pages_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."content_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."css_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."group_perms_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."groups_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."htmlblobs_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."additional_htmlblob_users_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."permissions_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."templates_seq", (int)$max+1);
	...
	#$db->CreateSequence($db_prefix."sequence_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."users_seq", (int)$max+1);
	...
	$db->CreateSequence($db_prefix."userplugins_seq", (int)$max+1);
