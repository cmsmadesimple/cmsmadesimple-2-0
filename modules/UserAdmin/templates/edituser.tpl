...
{/if}
  ...
  {mod_formrow name='username'}
    {mod_label name="username"}{tr}Username{/tr}:*{/mod_label}
    {mod_textbox name="username" value=$user->name size="25" maxlength="25"}
  ...
  {mod_formrow name='first_name'}
    ...
    {mod_textbox name="first_name" value=$user->firstname size="25" maxlength="25"}
    {mod_helptext name='first_name' value='help-input_first_name'}
  {/mod_formrow}

  {mod_formrow name='last_name'}
    {mod_label name="last_name"}{tr}Last Name{/tr}:{/mod_label}
    {mod_textbox name="last_name" value=$user->lastname size="25" maxlength="25"}
    {mod_helptext name='first_name' value='help-input_last_name'}
  {/mod_formrow}
  ...
  {mod_formrow name='email'}
    ...
    {mod_helptext name='first_name' value='help-input_email'}
  {/mod_formrow}
  ...
  {mod_formrow name='repeat'}
    ...
    {mod_password name="repeat" size="25" maxlength="25"}
  ...
  {mod_formrow name='active'}
    ...
    {mod_checkbox name="active" selected="$user->active"}
  ...
  {/if}
	...
	{assign var='selected' value=$onegroup->member}
        ...
        <tr>
          ...
          <td>{mod_checkbox name="groups[$tmp]" selected="$selected"}</td>
        </tr>
      {/foreach}
      </table>
      <br/>
