...
{mod_form action=$module_action}
  {mod_formrow name="password_minlength"}
    ...
    {mod_textbox name='password_minlength' value=$cms_mapi_module->Preference->get('password_minlength') size="5" maxlength="5"}
  ...
  {mod_formrow name="username_minlength"}
    ...
    {mod_textbox name='username_minlength' value=$cms_mapi_module->Preference->get('username_minlength') size="5" maxlength="5"}
